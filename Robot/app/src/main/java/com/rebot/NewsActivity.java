    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (code.equals("302000")) {
                ...
                wqRecycleAdapter = new WQRecycleAdapter(this, R.layout.item_news, newss);
                ...
                wqRecycleAdapter = new WQRecycleAdapter(this, R.layout.item_news, caipus);
            }
            ...
            public <T> void convert(WQViewHolder holder, T bean, int position) {
                ...
                if (code.equals("302000")) {
                    ...
                    if (n.getIcon().equals("")) {
                        ...
                        holder.setImageResource(NewsActivity.this, R.id.item_news_img, n.getIcon());
                    }
                } else {
                    Caipu c = (Caipu) bean;
                    ...
                    if (c.getIcon().equals("")) {
                        ...
                        holder.setImageResource(NewsActivity.this, R.id.item_news_img, c.getIcon());
                    }
                }
